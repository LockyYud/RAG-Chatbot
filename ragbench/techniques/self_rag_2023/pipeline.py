...
from ragbench.core.interfaces import BaseVerifier
...
from ragbench.core.schema import ArtifactManifest, BuiltContext, RAGAnswer, VerificationReport
...
from ragbench.processing.chunkers.parent_child import ParentChildChunker
...
from ragbench.providers.llm_client import LLMClient, check_provider_ready
            ...
            messages=[
                ...
                },
                {
                    ...
                    "content": (
                        ...
                        f"ANSWER:\n{answer.answer}\n\n"
                        f"ANSWER_CITATIONS:\n"
                        f"{json.dumps([c.doc_id for c in answer.citations], ensure_ascii=False)}\n\n"
                        f"CONTEXT:\n{context.text}"
                    ),
                },
            ],
