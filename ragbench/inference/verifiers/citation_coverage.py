...
from ragbench.core.schema import BuiltContext, RAGAnswer, VerificationReport
...
class CitationCoverageVerifier(BaseVerifier):
    ...
    def verify(self, answer: RAGAnswer, context: BuiltContext) -> VerificationReport:
        ...
        unsupported = [citation.doc_id for citation in answer.citations if citation.doc_id not in supported]
